...
namespace Microsoft.Solutions.PatientHub.BatchInferenceService.Tests
{
    ...
    public class ExplanationServiceTests : TestBase
    {
        ...
        {
            columnLookupValueService = new ColumnLookupValueService(Config["Values:DBConnectionString"], "PatientData", "ColumnLookupValues");
            explanationService = new ExplanationService(Config["Values:DBConnectionString"], "PatientData", "Explanations");
        }
