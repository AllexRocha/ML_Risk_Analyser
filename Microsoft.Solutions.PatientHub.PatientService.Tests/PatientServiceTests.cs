...
namespace Microsoft.Solutions.PatientHub.PatientService.Tests
{
    ...
    public class PatientServiceTests : TestBase
    {
        ...
        {
            patientService = new PatientService(Config["Values:DBConnectionString"], "PatientData", "Patient");
            admissionTypeService = new AdmissionService(Config["Values:DBConnectionString"], "PatientData", "AdmissionType");
        }
        ...
        {
            var result = await patientService.GetPatient("50985");
        ...
        {
            var result = await patientService.UpdateScore("50985", (decimal)0.5);
            Assert.IsNotNull(result);
        }
        ...
        {
            BasicPatientProfile newPatient = new BasicPatientProfile() { LastName = "John2", FirstName = "Tres", Age = 30, Gender = Gender.Male };
