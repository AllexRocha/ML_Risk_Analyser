    ...
    public class RealtimeInferenceTests : TestBase
    {
        ...
        public void TestInit()
        {
            ...
            RealtimeInferenceTests.columnNameMapService =
                new ColumnNameMapService(Config["Values:DBConnectionString"], "PatientData", "ColumnNameMap");
            RealtimeInferenceTests.columnLookupValueService =
          new ColumnLookupValueService(Config["Values:DBConnectionString"], "PatientData", "ColumnLookupValues");
        }
